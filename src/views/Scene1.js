...
export default function Scene1({ ...props }) {
  ...
  const astroid2 = useRef()
  const astroid3 = useRef()
  const astroid4 = useRef()
  ...
  useFrame(() => {
    ...
    if((thePlayer.current.position.x >= astroid.current.position.x -300) &&(thePlayer.current.position.x <= astroid.current.position.x +600) && (astroid.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid.current.position.z +250) && !collusion.current ){
      console.log('***** astroid collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid1.current.position.x -300) &&(thePlayer.current.position.x <= astroid1.current.position.x +600) && (astroid1.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid1.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 1 collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid2.current.position.x -300) &&(thePlayer.current.position.x <= astroid2.current.position.x +600) && (astroid2.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid2.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 2 collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid3.current.position.x -300) &&(thePlayer.current.position.x <= astroid3.current.position.x +600) && (astroid3.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid3.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 3 collusion ********');
      collusion.current = true
    }



    if((thePlayer.current.position.x >= astroid4.current.position.x -300) &&(thePlayer.current.position.x <= astroid4.current.position.x +600) && (astroid4.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid4.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 4 collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid5.current.position.x -300) &&(thePlayer.current.position.x <= astroid5.current.position.x +600) && (astroid5.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid5.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 5 collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid6.current.position.x -300) &&(thePlayer.current.position.x <= astroid6.current.position.x +600) && (astroid6.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid6.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 6 collusion ********');
      collusion.current = true
    }

    if((thePlayer.current.position.x >= astroid7.current.position.x -300) &&(thePlayer.current.position.x <= astroid7.current.position.x +600) && (astroid7.current.position.z + -500<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid7.current.position.z +250) && !collusion.current ){
      console.log('***** astroid 7 collusion ********');
      collusion.current = true
    }
    
    // console.log(thePlayer.current.position.z)
    // if((astroid.current.position.z -100<= thePlayer.current.position.z) &&(thePlayer.current.position.z <= astroid.current.position.z +100) ){
    //   console.log('*****Z collusion ********');
    // }
